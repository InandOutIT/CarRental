...
<html lang="en">
    ...
    <head>
		...
		<link rel="stylesheet" href="Carassets/css/style.css">
    ...
    <body>
		...
		<script src="Carassets/js/jquery-3.3.1.min.js"></script>
		<script src="Carassets/js/jquery-migrate-3.0.0.min.js"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
		<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
        <script src="Carassets/js/jquery.backstretch.min.js"></script>
        <script src="Carassets/js/wow.min.js"></script>
        <script src="Carassets/js/jquery.waypoints.min.js"></script>
        <script src="Carassets/js/jquery.mCustomScrollbar.concat.min.js"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.isotope/2.2.2/isotope.pkgd.min.js"></script>
        <script src="Carassets/js/scripts.js"></script>
